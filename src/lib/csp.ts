...
export function buildCspHeader(nonce: string, allowedOrigins: string[] = []): string {
  ...
  const csp = `
    default-src 'self';
    script-src 'self' 'nonce-${nonce}' 'sha256-TiyWB4YB4NUrUHDJSqaW0w0OtUb7i0Tddwwo6j0O07c=' 'sha256-HugGj5oR7f2UGBbrPIOJua5vPpKBIJj8354Z6gsKoUQ=' 'sha256-7mu4H06fwDCjmnxxr/xNHyuQC6pLTHr4M2E4jXw5WZs=' https://va.vercel-scripts.com ${isDev ? "'unsafe-eval'" : ''};
